...
def busqueda_ramificacion_acotacion(problem):
    return graph_search(problem, colaOrdenada())

def busqueda_ramificacion_acotacion_subestimada(problem):
    return graph_search(problem, colaOrdenadaCoste(problem))

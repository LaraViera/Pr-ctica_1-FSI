...
class colaOrdenada(Queue):
    ...
    def extend(self, items):
        self.A.extend(items)
        # creamos una funcion lambda que tratara cada uno de los nodos de la cola
        # devolviendo el path_cost de cada nodo y ordenando la lista en funcion de este valor
